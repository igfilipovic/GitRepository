...
<center>
    ...
    <div>
        <table>
            <tr>
                <td align="center">
                    <a href="Lista_sudionika.aspx" title="Idi na listu sudionika"><img src="msp_logo.jpg" alt="MSP logo" /></a><br />
                    <br />
                    <br />
                    <br />
                    <br />
...
&nbsp;</td>
            ...
            <tr>
                <td class="style1" align="center">
                    ...
                    <br />
                    <br />
                    <asp:Label ID="lbl_sudionik" runat="server" Font-Size="90px"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style2" align="center">
                    ...
                    <asp:Label ID="lbl_error" runat="server" ForeColor="Red" 
                        Text="U tablici ne postoji niti jedan sudionik. Unesite prvo sudionika!" 
                        Visible="False"></asp:Label>
                    <br />
                    <br />
                    <br />
                    <asp:Button ID="btn_pick" runat="server" Text="Izaberi dobitnika" 
